...
@section('pageName','الاقسام الفرعيه')
@section('thead')
    <tr>
...
@section('modal')
    @include('admin.libraries.librariesSubCategories.create',['id'=>'createmodal','name'=>'الاقسام الفرعيه','action'=>url()->current()])
@stop
@endif
        ...
        $(document).ready(function () {
            ...
            var dataListView = $(".data-list-view").DataTable({
                ...
                buttons: [
                        @if (auth()->User()->group->categories_add == 1)
                    {
                        text: "<i class='feather icon-plus'></i>اضف فرع جديد ",
                        action: function () {
